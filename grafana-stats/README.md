StatsD + Grafana + InfluxDB + Sample Dashboard
----------------------------------------------

This image contains a sensible default configuration of StatsD, Grafana, and InfluxDB and comes bundled with a example
dashboard that gives you the basic metrics. There are two ways for using this image:
